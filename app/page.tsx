...
export default async function Home() {
  const { resultats, total } = await fetchRepetiteurs(6);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans">
      ...
      {/* ══════════ 1. HERO ══════════ */}
      <section className="relative overflow-hidden bg-linear-to-br from-orange-50 to-amber-200  sm:py-10 rounded-b-4xl">
        {/* Pattern grille */}
        <div
          aria-hidden
        ...
        <div className="relative max-w-4xl mx-auto flex flex-col items-center text-center gap-8">
          ...
          <div className="flex flex-col gap-3">
            <h1 className="sm:text-3xl md:text-5xl font-black text-black leading-[1.8] tracking-tight">
              Trouvez votre<br />
              <span className="text-black">répétiteur parfait</span><br />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {TEMOIGNAGES.map((t) => (
              <div
                key={t.nom}
                className="bg-white rounded-3xl border border-zinc-100 p-20 p flex flex-col gap-4 "
              >
                ...
                <p className="text-zinc-600 text-xl leading-relaxed flex-1 italic">
                  &ldquo;{t.texte}&rdquo;
                </p>
